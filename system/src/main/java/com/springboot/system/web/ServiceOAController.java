...
import com.springboot.architecture.SecondDruidDbConfig;
...
public class ServiceOAController {
    ...
    public String index(@RequestParam("url")String url) {
        ...
        return "redirect:http://88.88.88.199/login/LinkOA.jsp?loginid="+hrmresource.getLoginid()+"&paswd="+pwd+"&url="+url;
    }
}
