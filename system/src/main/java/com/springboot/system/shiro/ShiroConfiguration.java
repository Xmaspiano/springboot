...
import com.springboot.architecture.filter.LoginFilter;
import com.springboot.architecture.filter.TokenOverFilter;
...
//启用缓存，默认false；
        ...
        authRealm.setAuthenticationCacheName("AuthenticationRetryCache");
        //启用授权缓存，即缓存AuthorizationInfo信息，默认false；
        authRealm.setAuthorizationCachingEnabled(true);
        //缓存AuthorizationInfo信息的缓存名称；
        authRealm.setAuthorizationCacheName("AuthorizationRetryCache");
